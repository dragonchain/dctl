...
program
  .description('Create a divi interchain network', {
  ...
  .option(
    '-t, --testnet',
    '(optional) Sets this interchain to use the divi testnet (defaults to mainnet). This value is automatically derived if providing private key as a WIF'
  )
...
util.wrapper(program, async client => {
  ...
  const response = await client.createDiviInterchain(
