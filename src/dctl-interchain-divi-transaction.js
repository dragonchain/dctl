...
program
  .description('Create/sign a divi transaction using a configured interchain', {
  ...
  .option(
    '-o, --outputs [outputs]',
    '(optional) JSON string array of divi transaction outputs for this transaction. i.e. \'[{"to":"1PGvDzfUUcCFp9cKNFMd5A1aPvnA2iswDD","value":0.0035}]\''
  )
...
util.wrapper(program, async client => {
  ...
  const response = await client.signDiviTransaction(
