...
program
  .description("Create a new Ethereum transaction using your dragonchain's private keys.", { to: "(Hex encoded string) Ethereum address to which this transaction will be addressed.", value: "(Hex encoded number) Amount of ETH to send." })
  .arguments("<to> <value>")
  .option("-t, --testNet", "(optional) Use Ethereum testnet (ETH_ROPSTEN)")
...
util.wrapper(program, async client => {
  try {
    ...
    const network = Boolean(testNet) ? "ETH_ROPSTEN" : "ETH_MAINNET";
